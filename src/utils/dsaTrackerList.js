...
const dsaTrackerList = [ 
    { 
        ...
        progress: 0, 
        subsections: [ 
            { subtitle: "Introduction to Data Structures", completed: false }, 
            { subtitle: "Choose Programming language", completed: false }, 
            { subtitle: "Learning Road map", completed: false }, 
        ], 
    },
    { 
        title: "ALGORITHMS", 
        progress: 0, 
        subsections: [ 
            { subtitle: "Introduction to ALGORITHMS", completed: false }, 
            { subtitle: "Learning Road map", completed: false }, 
            { subtitle: "How to apply", completed: false }, 
        ], 
    },
    { 
        title: "ARRAYS", 
